...
| **F7.2 ROAR (Faithfulness)** | **Computational** | *Remove And Retrain (ROAR)* requires retraining the LLM dozens of times to measure accuracy drops when top features are removed. We utilize scores (LIME 0.58, SHAP 0.60) obtained by running this benchmark. 
